...
public class ListWorksByAuthorUseCase {

    private final WorkRepository workRepository;
    private final LanguageRepository languageRepository;
    private final CategoryRepository categoryRepository;

    public ListWorksByAuthorUseCase(WorkRepository workRepository, LanguageRepository languageRepository, CategoryRepository categoryRepository) {
        this.workRepository = workRepository;
        this.languageRepository = languageRepository;
        this.categoryRepository = categoryRepository;
    }

    public List<WorkResponseDTO> execute(Long authorId) {
        return workRepository.findByAuthorId(authorId).stream()
                .map(this::toWorkDTO)
                .toList();
    }
