...
public class ListWorksByLanguageUseCase {

    private final WorkRepository workRepository;
    private final LanguageRepository languageRepository;
    private final CategoryRepository categoryRepository;

    public ListWorksByLanguageUseCase(WorkRepository workRepository, LanguageRepository languageRepository, CategoryRepository categoryRepository) {
        this.workRepository = workRepository;
        this.languageRepository = languageRepository;
        this.categoryRepository = categoryRepository;
    }

    public List<WorkResponseDTO> execute(Long languageId) {
        return workRepository.findByOriginalLanguageId(languageId).stream()
                .map(this::toWorkDTO)
                .toList();
    }
