...
public final class BooksRoutes {
    ...
    public static void register(JavalinConfig config,
                                ...
                                ReactivateWorkController reactivateWorkController,
                                ...
                                ReactivateEditionController reactivateEditionController,
                                ...
                                ReactivateAuthorController reactivateAuthorController,
                                ...
                                ReactivatePublisherController reactivatePublisherController,
                                ...
                                ReactivateLanguageController reactivateLanguageController,
                                ...
                                ReactivateBookFormatController reactivateBookFormatController,
                                ...
                                UpdateCategoryController updateCategoryController,
                                 ...
                                 ReactivateCategoryController reactivateCategoryController,
                                 ...
                                 ReactivateAuthorRoleController reactivateAuthorRoleController,
        ...
        config.routes.post("/books/works/{id}/reactivate", reactivateWorkController::reactivateWork);
        ...
        config.routes.post("/books/editions/{id}/reactivate", reactivateEditionController::reactivateEdition);
        ...
        config.routes.post("/books/authors/{id}/reactivate", reactivateAuthorController::reactivateAuthor);
        ...
        config.routes.post("/books/publishers/{id}/reactivate", reactivatePublisherController::reactivatePublisher);
        ...
        config.routes.post("/books/languages/{id}/reactivate", reactivateLanguageController::reactivateLanguage);
        ...
        config.routes.post("/books/formats/{id}/reactivate", reactivateBookFormatController::reactivateBookFormat);
        ...
        config.routes.post("/books/categories/{id}/reactivate", reactivateCategoryController::reactivateCategory);
        ...
        config.routes.post("/books/authorRoles/{id}/reactivate", reactivateAuthorRoleController::reactivateAuthorRole);
